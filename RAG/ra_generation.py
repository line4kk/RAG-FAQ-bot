    ...
    def get_response(self, text : str, model : str="gemini-2.5-flash", kw_res_max_len=2, emb_res_max_len=3) -> str:
        ...
        parts = [
            ...
            (
                ...
                "Если предоставленные вопросы и ответы не содержат нужной пользователю информации,"
                "не выдумывай ответ. Ты должен давать строго ту информацию, которая указана в базе данных."
